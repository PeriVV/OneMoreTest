...
def test(rootpath, name, dataset):
    ...
    print(
        'tn100: %.1f  fn100: %.1f  tn10:%.1f fn10:%.1f tn5:%.1f fn5:%.1f tn1:%.1f max_pre100: %.1f max_pre10:%.1f max_pre5:%.1f max_pre1:%.1f'
        % (tn100, fn100, tn10, fn10, tn5, fn5, tn1, max_pre100, max_pre10, max_pre5, max_pre1))

    # arr_dis, arr_match_rate = calculate_dis_array(y_pred, y_original_test, y_len_test)
    # seq_dis, seq_match_rate, max_seq_dis, min_seq_dis = calculate_dis_seq(y_pred, y_original_test, y_len_test)
